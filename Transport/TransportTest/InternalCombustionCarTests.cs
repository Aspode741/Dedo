...
{
    [TestFixture]
    public class InternalCombustionCarTests
    {
        [Test]
        public void ConstructorTest()
        {
            ...
            Assert.That(car.Transmission, Is.EqualTo(TransmissionType.Automatic));
            Assert.That(car.Cylinders, Is.EqualTo(4));
            Assert.That(car.Fuel, Is.EqualTo(FuelType.Gasoline));
        }
        ...
        private InternalCombustionCar CreateTestCar()
        {
